...
#ifdef WIN32
	#ifdef _UTILSDLL
		#define ExportedUtilsObject __declspec( dllexport )
		#ifdef QPAYEXT
			#define ExportedUtilsObjectExt __declspec( dllexport )
		#else
			#define ExportedUtilsObjectExt __declspec( dllimport )
		#endif
		#define EXPIMP_TEMPLATE
	#else
		#define ExportedUtilsObject __declspec( dllimport )
		#define ExportedUtilsObjectExt __declspec( dllimport )
		#define EXPIMP_TEMPLATE extern
	#endif
#else
	#define ExportedUtilsObject 
	#define ExportedUtilsObjectExt
	#define EXPIMP_TEMPLATE
#endif
...
namespace FinTP
{
	...
	*/
	class ExportedUtilsObject VersionInfo
	{
		private : 
			/// \brief Constructor
			VersionInfo(){};
